    ...
    render() {
        return (
            <Layout placeholder={false}>
                            ...
                            >
                                ...
                                >
                                    ...
                                    <image
                                        ...
                                        width="100"
                                        y="0"
										alt="Photo by Nick Demou from Pexels"
                ...
                <PortfolioList />
				<div style={{ marginLeft: "11%", marginBottom: "20px", justifyContent: "center" }}>
					<p className="caption text-tertiary">
					Vše je připraveno na Vaši návštěvu&nbsp;:)
					</p>
					<br />
					<img width="45%" alt="kadeřnictví" src="/images/mima1.jpeg" />
					<img width="45%" alt="kadeřnictví" src="/images/mima2.jpeg" />
				</div>
                <Contact />
            </Layout>
        );
